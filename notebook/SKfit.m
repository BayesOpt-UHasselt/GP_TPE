function model = SKfit(X, Y, B, Vhat, gammaP, seed)
...
myopt = optimset('Algorithm','interior-point','Display','none','MaxFunEvals',1000000,'MaxIter',500);
% myopt = optimset('Display','iter','MaxFunEvals',1000000,'MaxIter',500);
parms = fmincon(@(x) logPL(x,k,d,D,B,V,Y,gammaP, seed),...
